...
class InletTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        des_vars.add_output('MN_inf', 0.5)
        des_vars.add_output('MN_out', 0.5)
        ...
        # total and static
        connect_flow(self.prob.model, 'flow_start.Fl_O', 'inlet.Fl_I')

        self.prob.model.connect("P", "flow_start.P")
        self.prob.model.connect("T", "flow_start.T")
        self.prob.model.connect("MN_inf", "flow_start.MN")
        self.prob.model.connect("MN_out", "inlet.MN")
    ...
    def test_case1(self):
        ...
        for i, data in enumerate(ref_data):
            ...
            self.prob['MN_inf'] = data[h_map['Fl_I.MN']]
            self.prob['MN_out'] = data[h_map['Fl_O.MN']]
            ...
            print(data[h_map['Fl_I.MN']], self.prob['flow_start.Fl_O:stat:MN'])
            print(data[h_map['Fl_I.V']], self.prob['flow_start.Fl_O:stat:V'])
